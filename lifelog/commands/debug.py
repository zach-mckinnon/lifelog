...
def show_file(
    key: str = typer.Argument(..., help="The config key of the file (e.g., TRACK_FILE, TIME_FILE, etc.)")
):
    """
    ...
    if key not in paths:
        console.print(f"[bold red]❌ No path found for key '{key}' in config.[/bold red]")
